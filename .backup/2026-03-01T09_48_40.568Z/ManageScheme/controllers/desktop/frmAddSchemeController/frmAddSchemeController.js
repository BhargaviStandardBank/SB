define({
  ...
  _initializeDefaultView: function() {
    // Set the ListBox to the first option
  ...
  _setupCommonOverlay: function(config) {
    ...
    // Close overlay (Cancel button is usually common)
  ...
  _onAddMethodSelection: function() {
    ...
    // Mapping keys exactly as they appear in your ListBox Master Data
