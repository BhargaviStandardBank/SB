define("ManageScheme/frmAddScheme", function() {
    return function(controller) {
        function addWidgetsfrmAddScheme() {
            ...
            voltmx.mvc.registry.add('FBox0d362f77aee3647', 'FBox0d362f77aee3647', 'FBox0d362f77aee3647Controller', {
                "appName": "ManageScheme"
            });
            var segMethodContainer = new voltmx.ui.SegmentedUI2({
                ...
                "rowSkin": "segTrans",
                "rowTemplate": "FBox0d362f77aee3647",
            ...
            var AddMethod = new com.hcl.lblList.LabelList({
                ...
                "overrides": {
                    ...
                    "listData": {
                        "masterData": [
                            ["MC", "Manual Company Entry (max 10 items)"],
                            ["UC", "Upload Company File"],
                            ["ME", "Manual Employee Entry (max 10 items)"],
            ...
            var FlexGroup0gde43ebbf92a4c = new voltmx.ui.FlexContainer({
                "autogrowMode": voltmx.flex.AUTOGROW_NONE,
                "bottom": "16dp",
                "clipBounds": false,
                "height": "40dp",
                "id": "FlexGroup0gde43ebbf92a4c",
                "isVisible": true,
                "layoutType": voltmx.flex.FREE_FORM,
                "isModalContainer": false,
                "right": "0dp",
            ...
            FlexGroup0gde43ebbf92a4c.setDefaultUnit(voltmx.flex.DP);
            ...
            FlexGroup0gde43ebbf92a4c.add(btnAddCompanyScheme);
            flxAddScheme.add(SubHdr, flxListMethod, flxAddMethod, flxSep, flxCompanyEntry, flxEmployeeEntry, flxDocSelect, CopyFlexContainer0acb437d183354f, FlexGroup0gde43ebbf92a4c);
        ...
        return [{
            "addWidgets": addWidgetsfrmAddScheme,
