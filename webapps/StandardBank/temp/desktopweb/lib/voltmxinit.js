...
(function() {
    var VERSION = '10.0.6.0.v202604101252',
        BUILD = 'debug',
        ECMAENABLE = '@ECMAENABLE', PUBLISH = true,
        UWPAPIS = (/true/i).test('false'),
        UWPOFFLINEAPIS = (/true/i).test('false'),
        PACKAGEASPORTLET = (/true/i).test('false'),
        UWPBUILD = (UWPAPIS || UWPOFFLINEAPIS);

    //eslint-disable-next-line no-unused-vars
    var PLATFORMBUILT = 'desktopweb';
