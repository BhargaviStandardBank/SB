define({
  ...
  populateEmployeeData: function() {
    try {
      var segmentData = [
        {
          "lblCIFNo": { "text": "23280545", "skin": "sknUnderlineLink" }, // Assuming it's underlined based on image
          "lblIDNo": "111235",
        ...
        {
          "lblCIFNo": { "text": "25323522", "skin": "sknUnderlineLink" },
          "lblIDNo": "232558",
        ...
        {
          "lblCIFNo": { "text": "85245623", "skin": "sknUnderlineLink" },
          "lblIDNo": "998524",
        ...
        {
          "lblCIFNo": { "text": "99855824", "skin": "sknUnderlineLink" },
          "lblIDNo": "220232134",
        ...
        {
          "lblCIFNo": { "text": "22355678", "skin": "sknUnderlineLink" },
          "lblIDNo": "652445342",
  ...
  _handleMethodSelection: function() {
    return new Promise((resolve) => {
      ...
      // Execute UI Update
      this._updateUI({ showSchemeSrch, showEmployeeSrch, showDocSelect, buttonText, populateEmployeeEntry, populateCompanyEntry });
      resolve(true);
    });
  },


  _updateUI: function({ showSchemeSrch = false, showEmployeeSrch = false, showDocSelect = false, buttonText = "", 
                       populateEmployeeEntry = false, populateCompanyEntry = false} = {}) {
    // Set Visibility
