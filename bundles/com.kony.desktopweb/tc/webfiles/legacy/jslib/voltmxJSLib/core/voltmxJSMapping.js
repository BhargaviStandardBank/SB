...
if($KI.os) {
    voltmx.os = {
        ...
        hasPasskeySupport: $KI.os.hasPasskeySupport,
...
if($KI.screenrecorder) {
    voltmx.screenrecorder = {
        start: $KI.screenrecorder.start,
        stop: $KI.screenrecorder.stop,
        pause: $KI.screenrecorder.pause,
        resume: $KI.screenrecorder.resume,
        getrecordeddata: $KI.screenrecorder.getrecordeddata,
        getrecordingstate: $KI.screenrecorder.getrecordingstate
    };
}

voltmx.screenshot = $KI.screenshot;
...
if($KI.credentialmanager) {
    voltmx.credentialmanager = {
        registerPasskey: $KI.credentialmanager.registerPasskey,
        signinWithPasskey: $KI.credentialmanager.signinWithPasskey,
        createPasskeySigninRequest: $KI.credentialmanager.createPasskeySigninRequest,
        createPasskeyRegistrationRequest: $KI.credentialmanager.createPasskeyRegistrationRequest
    };
}
...
voltmx.media.record = $KI.media.record;
...
voltmx.push.deRegister = $KI.push.deregister;
voltmx.push.register = $KI.push.register;
voltmx.push.setCallbacks = $KI.push.setCallbacks;
