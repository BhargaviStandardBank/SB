define("ManageScheme/userfrmSchemeReqHistoryController", {
    /** ---------------- STATE ---------------- **/
    _masterData: [],
    _filteredData: [],
    _currentFilter: "ALL",
    ...
    /** ---------------- SEARCH ---------------- **/
    _onSearch: function() {
        const text = (this.view.SrchTextBox.txtSrch.text || "").toLowerCase().trim();
    ...
    _applyFilters: function(search = "") {
        ...
        /** 2. Search filter */
        if (search) {
            data = data.filter(x => x.id.toLowerCase().includes(search) || x.type.toLowerCase().includes(search) || x.initiator.toLowerCase().includes(search));
        }
        this._filteredData = data;
        this._setMainSegment(data);
    },
...
define("ManageScheme/frmSchemeReqHistoryControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
});
define("ManageScheme/frmSchemeReqHistoryController", ["ManageScheme/userfrmSchemeReqHistoryController", "ManageScheme/frmSchemeReqHistoryControllerActions"], function() {
    var controller = require("ManageScheme/userfrmSchemeReqHistoryController");
    var controllerActions = ["ManageScheme/frmSchemeReqHistoryControllerActions"];
