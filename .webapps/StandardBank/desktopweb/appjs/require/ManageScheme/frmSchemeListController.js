define("ManageScheme/userfrmSchemeListController", {
    /** ---------------- STATE ---------------- **/
    _masterData: [],
    /** ---------------- ENTRY ---------------- **/
    onNavigate: function() {
    ...
    _loadSchemeListData: function() {
        ...
        const data = [{
            ...
            name: "Solar Energies",
            cif: "91518892",
            company: "Solar Panels LLC",
            reg: "884558125",
            status: "Inactive"
        }, {
            id: "987653",
            name: "BestMart Retail",
            cif: "64265024",
            company: "BestMart Furniture Mfg",
            reg: "225655227",
            status: "Inactive"
        }, {
            id: "987654",
    ...
    _onSearchScheme: function() {
        ...
        const filtered = this._masterData.filter(item => item.id.toLowerCase().includes(searchText) || item.name.toLowerCase().includes(searchText) || item.cif.toLowerCase().includes(searchText) || item.company.toLowerCase().includes(searchText));
...
define("ManageScheme/frmSchemeListControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
});
define("ManageScheme/frmSchemeListController", ["ManageScheme/userfrmSchemeListController", "ManageScheme/frmSchemeListControllerActions"], function() {
    var controller = require("ManageScheme/userfrmSchemeListController");
    var controllerActions = ["ManageScheme/frmSchemeListControllerActions"];
