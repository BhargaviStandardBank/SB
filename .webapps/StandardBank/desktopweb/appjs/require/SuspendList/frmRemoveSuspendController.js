define("SuspendList/userfrmRemoveSuspendController", {
    ...
    populateSourceData: function() {
        const sourceData = [{
            "lblSource": "Manual entry(max 10 items)",
            "id": "MANUAL"
        }, {
            "lblSource": "Upload file",
            "id": "UPLOAD"
        }];
...
define("SuspendList/frmRemoveSuspendControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
});
define("SuspendList/frmRemoveSuspendController", ["SuspendList/userfrmRemoveSuspendController", "SuspendList/frmRemoveSuspendControllerActions"], function() {
    var controller = require("SuspendList/userfrmRemoveSuspendController");
    var controllerActions = ["SuspendList/frmRemoveSuspendControllerActions"];
