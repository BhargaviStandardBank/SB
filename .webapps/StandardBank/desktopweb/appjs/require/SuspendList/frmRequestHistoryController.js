define("SuspendList/userfrmRequestHistoryController", {
    masterHistoryData: [{
        date: "01/01/2026",
        id: "0012345",
        type: "Suspension",
    ...
    applyCombinedFilters: function() {
        ...
        const filteredResults = this.masterHistoryData.filter(item => {
            ...
            const statusMatch = (selectedStatus === "All") || (item.status.includes(selectedStatus));
            // 2. Check Search Condition
            const searchMatch = !searchText || item.id.toLowerCase().includes(searchText) || item.type.toLowerCase().includes(searchText) || item.initiator.toLowerCase().includes(searchText);
...
define("SuspendList/frmRequestHistoryControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
});
define("SuspendList/frmRequestHistoryController", ["SuspendList/userfrmRequestHistoryController", "SuspendList/frmRequestHistoryControllerActions"], function() {
    var controller = require("SuspendList/userfrmRequestHistoryController");
    var controllerActions = ["SuspendList/frmRequestHistoryControllerActions"];
